...
const createAsteroids = () =>{
  for(let i = 0; i<= 15; i++) {
    ...
    const x = random(1, 550);
    const y = random(1, 10);
    const dy = random(-5, 5) || 2;
    const dx = random(-5, 5) || 2;
...
const randomStars = () => {
  ...
  return random([[0.2, 2, randomAccForSmall],[0.2, 2, randomAccForSmall],[0.2, 2, randomAccForSmall],[0.2, 2, randomAccForSmall],[0.2, 2, randomAccForSmall],[0.2, 2, randomAccForSmall],[0.2, 2, randomAccForSmall], [0.4, 4, randomAccForLargeAndMed], [0.6, 5, randomAccForLargeAndMed]]);
}
